...
export class CanvasWhiteboardComponent {
    ...
    static { this.ɵfac = function CanvasWhiteboardComponent_Factory(t) { return new (t || CanvasWhiteboardComponent)(i0.ɵɵdirectiveInject(i0.NgZone), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(i1.CanvasWhiteboardService), i0.ɵɵdirectiveInject(i2.CanvasWhiteboardShapeService)); }; }
