...
export declare class CanvasWhiteboardComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
     ...
     */
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<CanvasWhiteboardComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<CanvasWhiteboardComponent, "canvas-whiteboard", never, { "options": { "alias": "options"; "required": false; }; "batchUpdateTimeoutDuration": { "alias": "batchUpdateTimeoutDuration"; "required": false; }; "imageUrl": { "alias": "imageUrl"; "required": false; }; "aspectRatio": { "alias": "aspectRatio"; "required": false; }; "drawButtonClass": { "alias": "drawButtonClass"; "required": false; }; "clearButtonClass": { "alias": "clearButtonClass"; "required": false; }; "undoButtonClass": { "alias": "undoButtonClass"; "required": false; }; "redoButtonClass": { "alias": "redoButtonClass"; "required": false; }; "saveDataButtonClass": { "alias": "saveDataButtonClass"; "required": false; }; "drawButtonText": { "alias": "drawButtonText"; "required": false; }; "clearButtonText": { "alias": "clearButtonText"; "required": false; }; "undoButtonText": { "alias": "undoButtonText"; "required": false; }; "redoButtonText": { "alias": "redoButtonText"; "required": false; }; "saveDataButtonText": { "alias": "saveDataButtonText"; "required": false; }; "strokeColorPickerText": { "alias": "strokeColorPickerText"; "required": false; }; "fillColorPickerText": { "alias": "fillColorPickerText"; "required": false; }; "drawButtonEnabled": { "alias": "drawButtonEnabled"; "required": false; }; "clearButtonEnabled": { "alias": "clearButtonEnabled"; "required": false; }; "undoButtonEnabled": { "alias": "undoButtonEnabled"; "required": false; }; "redoButtonEnabled": { "alias": "redoButtonEnabled"; "required": false; }; "saveDataButtonEnabled": { "alias": "saveDataButtonEnabled"; "required": false; }; "shouldDownloadDrawing": { "alias": "shouldDownloadDrawing"; "required": false; }; "colorPickerEnabled": { "alias": "colorPickerEnabled"; "required": false; }; "strokeColorPickerEnabled": { "alias": "strokeColorPickerEnabled"; "required": false; }; "fillColorPickerEnabled": { "alias": "fillColorPickerEnabled"; "required": false; }; "lineWidth": { "alias": "lineWidth"; "required": false; }; "strokeColor": { "alias": "strokeColor"; "required": false; }; "startingColor": { "alias": "startingColor"; "required": false; }; "scaleFactor": { "alias": "scaleFactor"; "required": false; }; "drawingEnabled": { "alias": "drawingEnabled"; "required": false; }; "showStrokeColorPicker": { "alias": "showStrokeColorPicker"; "required": false; }; "showFillColorPicker": { "alias": "showFillColorPicker"; "required": false; }; "downloadedFileName": { "alias": "downloadedFileName"; "required": false; }; "lineJoin": { "alias": "lineJoin"; "required": false; }; "lineCap": { "alias": "lineCap"; "required": false; }; "shapeSelectorEnabled": { "alias": "shapeSelectorEnabled"; "required": false; }; "showShapeSelector": { "alias": "showShapeSelector"; "required": false; }; "fillColor": { "alias": "fillColor"; "required": false; }; }, { "onClear": "onClear"; "onUndo": "onUndo"; "onRedo": "onRedo"; "onBatchUpdate": "onBatchUpdate"; "onImageLoaded": "onImageLoaded"; "onSave": "onSave"; }, never, never, false, never>;
}
